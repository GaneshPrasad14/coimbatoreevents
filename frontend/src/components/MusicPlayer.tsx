...
export function MusicPlayer() {
    ...
    return (
        <div className={`fixed bottom-4 right-4 z-50 transition-all duration-300 ${isExpanded ? 'w-96' : 'w-16'} animate-float`}>
            <div className={`bg-black/80 backdrop-blur-md rounded-full shadow-[0_0_15px_rgba(236,72,153,0.3)] border border-white/10 overflow-hidden transition-all duration-300 ${isExpanded ? 'p-3' : 'p-2'} animate-breathe`}>
                <audio
                    ref={audioRef}
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className={`relative flex items-center justify-center rounded-full bg-gradient-to-r from-pink-500 via-purple-500 to-orange-500 text-white shadow-lg flex-shrink-0 transition-all duration-300 ${isExpanded ? 'w-12 h-12' : 'w-12 h-12'}`}
                    >
                        {isPlaying ? (
                                    ...
                                    {isPlaying && (
                                        <div className="flex items-end gap-[2px] h-3">
                                            {[...Array(8)].map((_, i) => (
                                                <div
                                                    key={i}
                                                    className="w-[2px] bg-gradient-to-t from-pink-500 via-purple-500 to-orange-500 rounded-full animate-wave"
                                                    style={{
